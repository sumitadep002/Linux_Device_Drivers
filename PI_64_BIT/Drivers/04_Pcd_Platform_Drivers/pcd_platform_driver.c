/*
 *This file is actual driver program for platform devices
 */
...
/*
 *Instead of Directly using numbers we can refer them by providing name
 */
 ...
 *Do not worry about config_item 1 and 2 treat them like somekind of identity data associated with devices 
 *which can be verified by the kernal which decinding driver-device attatchement
 */
 ...
 *It wil store the information like size of buffer and buffer itself and device_number
 */
 ...
 *To store the number of devices, device base number, class and device variable
 */
...
/*
 *Check for the match between whether user program is allowed for asked service or not
 */
...
/*
 *Whenever the device is detected in the bus
 *This probe funcion will get called
 */
int pcd_platform_driver_probe(struct platform_device *pdev)
{
	...
	*NOTE: no need to free the memory explictly, it will be done by kernel automatically
	*/
